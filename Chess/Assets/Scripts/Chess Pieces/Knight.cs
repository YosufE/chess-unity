...
public class Knight : ChessPiece
{
    ...
    {
        Vector3Int topRight = get_current_cell();
    ...
    {
        Vector3Int rightTop = get_current_cell();
    ...
    {
        Vector3Int topLeft = get_current_cell();
    ...
    {
        Vector3Int leftTop = get_current_cell();
    ...
    {
        Vector3Int bottomLeft = get_current_cell();
    ...
    {
        Vector3Int leftBottom = get_current_cell();
    ...
    {
        Vector3Int bottomRight = get_current_cell();
    ...
    {
        Vector3Int rightBottom = get_current_cell();
